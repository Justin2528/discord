...
module.exports.run = async (client, message, args) => {
    ...
    if (!message.member.hasPermission("VIEW_AUDIT_LOG")) return send(message.channel, "Permission Need: View Audit Log.  Sorry, but you do not have valid permissions! If you believe this is an error, contact an owner.", {
        name: 'Warn Error',
    ...
    if (!modlog) return message.channel.send('**Please create a channel with the name `ban-kick-warning`**')
